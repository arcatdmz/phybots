...
/**
 * Class for managing message resources. Generated automatically by Eclipse refactoring tool.
 */
public class Messages {
	private static final String BUNDLE_NAME = "jp.digitalmuseum.napkit.gui.resources"; //$NON-NLS-1$
